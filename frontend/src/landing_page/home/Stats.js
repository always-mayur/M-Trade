        ...
        <div className='container mt-1'>
            <div className='row '>
                <div className='col-6 p-5'>
                    ...
                    <p className='text-muted'>That's why 1.5+ crore customers trust Zerodha with ₹4.5+ 
                    ...
                    <h2 className='fs-4'>The MyTrade universe</h2>
                ...
                {/* <div className ='text-center'>
                    <a href='' className='mx-5' style={{textDecoration:"none"}}>Explore our products<i 
