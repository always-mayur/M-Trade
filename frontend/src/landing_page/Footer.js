    ...
    return ( 
        <div className='container border-top mt-5'>
            <div className='row mt-5'>
                <div className='col'>
                    <img src='/media/myTradeLogo.png' alt='logo' style={{width:"50%"}}></img> <br/>
                    &copy; 2010 - 2025, <br/> 
                    MyTrade Broking Ltd.<br/>All rights reserved.
                </div>
                <div className='col' ><h3>Comapany</h3>
                ...
                <div className='col'><h3>Support</h3>
                ...
                <div className='col'><h3>Account</h3>
